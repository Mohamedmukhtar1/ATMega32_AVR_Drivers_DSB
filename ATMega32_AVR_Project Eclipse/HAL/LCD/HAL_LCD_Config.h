...
#define FLOAT_RESELUTION		1000

#define LCD_8BIT_DATA_PORT      GPIOB
#define LCD_4BIT_DATA_PORT      GPIOA
...
#define LCD_DATA_4_PIN	   GPIO_PIN_3   //the manufacturer is using _4_BIT_MODE
#define LCD_DATA_5_PIN	   GPIO_PIN_4   //the manufacturer is using _4_BIT_MODE
#define LCD_DATA_6_PIN	   GPIO_PIN_5   //the manufacturer is using _4_BIT_MODE
#define LCD_DATA_7_PIN     GPIO_PIN_6   //the manufacturer is using _4_BIT_MODE
